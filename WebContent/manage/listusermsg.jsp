...
<form id="queryform" name="queryform" action="<%=base %>/Manage?type=listusermsg" method="post">

	发送人ID:<input type="text"  style="width: 80px;" id="fromid" name="fromid" value="${requestScope.fromid}" /> 
 	接收人ID:<input type="text"  style="width: 80px;" id="toid" name="toid" value="${requestScope.toid}" /> 
 	发送人昵称:<input type="text"  style="width: 80px;" id="fromusername" name="fromusername" value="${requestScope.fromusername}" /> 
 	接收人昵称:<input type="text"  style="width: 80px;" id="tousername" name="tousername" value="${requestScope.tousername}" /> 
	...
	<table  class="table" id="table">
		<tr>
			...
			<td > <div onclick="getElementById('ORDER').value='toid'; getElementById('queryform').submit();">接收人ID</div> </td>
			<td > <div onclick="getElementById('ORDER').value='fromusername'; getElementById('queryform').submit();">发送人昵称</div> </td>
			<td > <div onclick="getElementById('ORDER').value='tousername'; getElementById('queryform').submit();">接收人昵称</div> </td>
			...
			<td > <div onclick="getElementById('ORDER').value='status'; getElementById('queryform').submit();">推送状态</div> </td>
